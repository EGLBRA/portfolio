...
(function () {
  var PAGES = [
    ...
    { file: 'case-02.html',  menu: 'Case 2',              title: 'A chegada como experiência, não como papelada' },
    { file: 'case-03.html',  menu: 'Case 3',              title: 'Inovação em Gente e Gestão: um ecossistema que aprende' },
  ...
  function currentFile() {
    ...
    return p && p.length ? p : 'equatorial.html';
  }

  var here = currentFile();
  var idx = PAGES.map(function (p) { return p.file; }).indexOf(here);

  /* A capa mora na raiz do site (equatorial.html) e as demais páginas em /equatorial/.
     Daqui sai o prefixo certo para cada uma, sem duplicar o menu. */
  var naCapa = (idx === -1);
  var base   = naCapa ? 'equatorial/' : '';
  var capa   = naCapa ? 'equatorial.html' : '../equatorial.html';
  ...
  brand.href = capa;
  brand.textContent = 'Book de Cases RH · Eric Leite & Grupo Equatorial';
